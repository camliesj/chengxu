...
test('智维车服 visible brand and launcher resources are installed across platforms', () => {
  assert.match(readText('../index.html'), /智维车服/);
  assert.match(readText('../src-tauri/tauri.conf.json'), /智维车服/);
  assert.match(readText('../android-client/app/src/main/res/values/strings.xml'), /智维车服/);
