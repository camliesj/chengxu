...
export async function onRequestGet({ env, params }) {
  let artifact;
  try {
    artifact = validateReleaseArtifact('android', params.version, decodeURIComponent(params.fileName));
  } catch {
  ...
  const headers = new Headers({
    'content-type': releaseDownloadContentType(artifact.platform),
