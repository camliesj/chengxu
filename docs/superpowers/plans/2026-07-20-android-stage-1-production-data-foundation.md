...
.\gradlew.bat :app:testDebugUnitTest --tests "*OrderStateMachineTest" --tests "*PermissionSnapshotTest"
```
...
- [x] **Step 5: 添加模型金额与未知状态测试并运行 GREEN**
...
```powershell
.\gradlew.bat :app:testDebugUnitTest --tests "*HttpUrlConnectionOrderReadApiTest"
```
...
```powershell
.\gradlew.bat :app:testDebugUnitTest --tests "*HttpUrlConnectionOrderReadApiTest" --tests "*HttpUrlConnectionOrdersApiTest"
.\gradlew.bat :app:testDebugUnitTest
```
...
```powershell
.\gradlew.bat :app:kspDebugKotlin :app:compileDebugAndroidTestKotlin
```
